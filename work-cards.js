...
const data = [
  ...
  },
  {
    name: "Poke Info",
    description:
      "A simple web page that shows a list of pokemon that the user can click to learn more about. Be aware, you have to login to interact... User: admin - Password: admin",
    featuredImage: "media/poke_info.png",
    tecnologies: ["ReactJS", "TailwindCSS", "Webpack"],
    liveVer: "https://steady-semifreddo-6df0fe.netlify.app",
    source: "https://steady-semifreddo-6df0fe.netlify.app",
  },
  {
    ...
    liveVer:
      "https://647261a75889953215239cc3--soft-entremet-9ffabe.netlify.app",
    source: "https://github.com/fasaldana/capstone_YGO",
  },
  {
    name: "Bookstore",
    description:
      "A bookstore app that allows users to add and remove books from the store. Also, users can see the progress of their reading.",
    featuredImage: "media/bookstorCMS.png",
    tecnologies: ["ReactJS", "CSS", "Redux", "Redux-toolkit"],
    liveVer:
      "https://6433a2b6a9fb4e51e99a3891--extraordinary-duckanoo-3cbf0b.netlify.app",
  ...
  },
  {
    ...
    tecnologies: ["ReactJS", "CSS", "Redux", "Redux-toolkit"],
    liveVer:
      "https://6430d4017e2e5238c70bbe3f--delightful-piroshki-d2715d.netlify.app",
